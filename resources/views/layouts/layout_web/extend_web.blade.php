                ...
                <div class="row">
                    <div class="col-md-4 clearfix">
                        <div class="logo pull-left">
                            <a href="{{asset('/shopwatch.com')}}"><img
                                    src="https://cdn3.dhht.vn/wp-content/uploads/2014/05/logo-hai-trieu3.png"
                                    alt="" /></a>
                        </div>
                    </div>
                    <div class="col-md-8 clearfix">
                        <div class="shop-menu clearfix pull-right">
                            <ul class="nav navbar-nav">
                                ...
                                <li><a href="{{asset('/shopwatch.com/checkout')}}"><i class="fa fa-crosshairs"></i>
                                        Checkout</a></li>
                                <li><a href="{{asset('/shopwatch.com/cart')}}"><i class="fa fa-shopping-cart"></i>
                                        Cart</a></li>
                                <li><a href="{{asset('/shopwatch.com/login')}}"><i class="fa fa-lock"></i> Login</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="mainmenu pull-left">
                            <ul class="nav navbar-nav collapse navbar-collapse">
                                <li><a href="{{asset('/shopwatch.com')}}" class="active">TRANG CHỦ</a></li>
                                <li class="dropdown"><a href="">THƯƠNG HIỆU<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
                                        @foreach($brands as $brand)
                                        <li><a href="{{asset('/shopwatch.com/brand')}}/{{$brand->id}}">Đồng Hồ
                                                {{$brand->name}}</a>
                                        </li>
                                        @endforeach
                                    </ul>
                                ...
                                <li class="dropdown"><a href="#">BLOG<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
                                        <li><a href="{{asset('/shopwatch.com/blog_list')}}">Blog List</a></li>
                                        <li><a href="{{asset('/shopwatch.com/blog_single')}}">Blog Single</a></li>
                                    </ul>
                                </li>
                                <li><a href="404.html">GIỚI THIỆU</a></li>
                                <li><a href="{{asset('/shopwatch.com/contact')}}">LIÊN HỆ</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-3">
