...
<head>
    ...
    <title>Shop Watch : Phiếu Chi</title>
    <link href="{{asset('admin/dist/css/styles.css')}}" rel="stylesheet" />
    <link href="{{asset('admin/dist/css/votes_pay.css')}}" rel="stylesheet" />
...
<body class="sb-nav-fixed">
                    ...
                    <div class="nav">
                        ...
                        <div class="form-group">
                            <div class="form-check">
                                <input class="form-check-input" id="searchVotesPay" type="text"
                ...
                <div class="container-fluid">
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            <a class="btn btn-primary" onclick="getDataVotesPay()" data-toggle="modal"
                                data-target="#modalAddVotesPay" style="float:right;">Thêm
                                Mới Phiếu Chi <i class="fa fa-plus"></i></a>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody id="list_votes_pay">
                                        @foreach($votes_pays as $key => $votes_pay)
                                        <tr>
                                            <td hidden>{{$key+1}}</td>
                                            <td>
                                                {{str_replace( substr( $votes_pay->voucher_code,  0, 2), 'PC', $votes_pay->voucher_code )}}
                                            </td>
                                            <td>{{$votes_pay->supplier_name}}</td>
                                            <td>{{$votes_pay->categories}}</td>
                                            <td>{{$votes_pay->datetime}}</td>
                                            <td>{{$votes_pay->total_money_votes_pay}}</td>
                                            <td>
                                                @if($votes_pay->categories_id == 4)
                                                Phiếu thanh toán cho chứng từ
                                                {{$votes_pay->voucher_code}}
                                                @else
                                                @endif
                                            </td>
                                            <td>
                                                <a class="btn btn-warning" data-toggle="modal"
                                                    data-target="#modalViewVotesPay"
                                                    onclick="ViewVotesPayByIdVotesPay('{{$votes_pay->id_votes_pay}}')"><i
                                                        class="fa fa-eye"></i></a>
                                                <a class="btn btn-primary"><i class="fa fa-print"></i></a>
                                                @if($votes_pay->categories_id != 4)
                                                <a class="btn btn-primary" data-toggle="modal"
                                                    data-target="#modalEditVotesPay"
                                                    onclick="EditVotesPay('{{$votes_pay->id_votes_pay}}')"><i
                                                        class="fa fa-edit"></i></a>
                                                @endif
                                                @if($votes_pay->categories_id != 4)
                                                <a class="btn btn-danger" data-toggle="modal"
                                                    data-target="#modalDeleteVotesPay"
                                                    onclick="getIdVotesPay('{{$votes_pay->id_votes_pay}}','{{$votes_pay->voucher_code}}')"><i
    ...
    <!-- modal votes Pay -->
    <div class="modal fade" id="modalViewVotesPay" role="dialog">
    ...
    <!-- modal add votes Pay -->
    <div class="modal fade" id="modalAddVotesPay" role="dialog">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 style="">THÊM MỚI PHIẾU CHI</h3>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                    ...
                    <form>
                        <div class="form-row" style="margin-top: 40px;">
                            <div class="form-group col-md-6">
                                <label for="inputCategories" style="margin-bottom: 0px;">Hạng Mục Phiếu Chi <i
                                        class="fa fa-plus" style="color:#0072BC;" data-toggle="modal"
                                        data-target="#categoriesModal"></i>
                                    <label style="color:#0072BC;">(Thêm
                                        mới)</label>
                                </label>
                                <select id="categories_votes_pay" class="form-control">

                                </select>
                            </div>
                            <div class="form-group col-md-6" style="margin-bottom: 0px;">
                                <label for="inputPayer">Người Nhận</label>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="datetime-local" class="form-control" id="datetime_votes_pay">
                            </div>
                            <div class="form-group col-md-6">
    ...
    <!-- end modal add votes Pay -->

    <!-- modal edit votes Pay -->
    <div class="modal fade" id="modalEditVotesPay" role="dialog">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 style="">CẬP NHẬT PHIẾU CHI</h3>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                    ...
                    <form>
                        <div class="form-row" style="margin-top: 40px;">
                            <div class="form-group col-md-6" hidden>
                                ...
                                <input type="text" class="form-control" id="id_votes_pay_edit">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="inputCategories">Hạng Mục Phiếu Chi</label>
                                <input type="text" class="form-control" id="categories_votes_pay_edit" disabled>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="inputPayer">Người Nhận</label>
                                <input type="text" class="form-control" id="supplierEdit" disabled>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="inputGioiTinh">Ngày Giao Dịch</label>
                                <input type="datetime-local" class="form-control" id="datetime_votes_pay_edit">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="inputEmai">Giá Trị</label>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-primary" onclick="updateVotesPay()"> <i
                                    class="fa fa-save"></i>
                                Save</button>
                            <button type="button" class="btn btn-danger" data-dismiss="modal"> <i
                                    class="fa fa-share"></i> Đóng</button>
    ...
    <div class="modal fade" id="categoriesModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">HẠNG MỤC PHIẾU CHI</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <div class="form-group">
                        <label for="inputAddress">Hạng Mục Phiếu Chi</label>
    ...
    <!-- Modal delete-->
    <div class="modal fade" id="modalDeleteVotesPay" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <p>Bạn có chắc chắn muốn xóa phiếu chi <span id="voucher_code_delete" style="font-weight: bold;">
                        </span>
                        không?</p>
                    <p id="id_votes_pay_delete" hidden></p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Thoát</button>
                    <button type="button" class="btn btn-primary" onclick="deleteVotesPay()" data-dismiss="modal">Đồng
                        ý</button>
                </div>
            </div>
        </div>
    ...
    <script src="{{asset('admin/dist/js/votes-pay.js')}}"></script>
</body>
